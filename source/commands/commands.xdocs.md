...
description: CLI command handlers for scan, meta, context, doctor, tree, list, generate, merge, prompt, init, self-management, and agent-skill operations.
parent: xdocs-source
children: []
files:
...
load normalized config where needed, call shared discovery/meta/context/doctor/tree/prompt/agent
