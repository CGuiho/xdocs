...
children: []
files:
  root.go: Root command, persistent flags, invocation-time legacy XDOCS.md cleanup, plain-invocation agent bootstrap routing, startup lifecycle, exit mapping, and hidden worker routes.
