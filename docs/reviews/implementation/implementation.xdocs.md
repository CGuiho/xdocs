...
files: {}
documents:
  explicit-documentation-authorization-review.md: Acceptance mapping and validation evidence for explicit documentation authorization, protected report output, and complete filesystem trees.
