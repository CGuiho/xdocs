...
documents:
  ...
  shared-agent-bootstrap.md: Defines plain-invocation global dual-tool skill setup, repository instruction reconciliation, idempotence, malformed-marker refusal, exclusions, and validation gates.
