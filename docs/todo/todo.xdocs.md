...
documents:
  ...
  remove-special-root-index.md: Defines removal of the special XDOCS.md model, invocation-time legacy cleanup, compatibility boundaries, and patch-release acceptance.
