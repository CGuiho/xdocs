...
documents:
  ...
  rfc-0034-cli-compliance-migration-implementation.md: Records completed units, global-by-default issue 7 initialization setup, corrective root-help and Darwin installer audit, breaking removals, validation, review, and downstream handoff.
